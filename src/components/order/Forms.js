...
import "../../index.scss"
import Cases from "../service-request/Cases";
      ...
      >
        <FlexGrid gutter={false} limitWidth={false} outsideGutter={false}>
          <FlexGrid.Row>
            ...
            {CasesIncidentFormConfig["selectchrome"].type === "select" && (
                <TwoGridLayout>
                  <Field
                    as={SelectInput}
                    value={values.selectchrome}
                    setFieldValue={setFieldValue}
                    label={CasesIncidentFormConfig["selectchrome"].label}
                    options={CasesIncidentFormConfig["selectchrome"].options}
                    name="selectchrome"
                    tooltip={<div style={{ color: colorCardinal }}>*</div>}
                    errors={touched["selectchrome"] && errors["selectchrome"]}
                  />
                </TwoGridLayout>
              )}
...
<SingleGridLayout>
            ...
            {CasesIncidentFormConfig["requestduration"].type === "select" && (
                <>
                  <Box>
                    <legend>
                      <Text bold size="medium">
              ...
              >
                <AttachmentContainer>
                  <IconOuterWrapper>
                    ...
                    <TextWrapper
                      inline
                      additionalProps={{ paddingLeft: "5px" }}
                    >
